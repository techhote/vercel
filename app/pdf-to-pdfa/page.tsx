...
import { Upload, FileText, Download, Loader2, Archive } from "lucide-react"
...
export default function PdfToPdfaPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast({ title: "Success", description: "PDF converted to PDF/A format successfully" })
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto max-w-4xl px-6">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-lg bg-blue-500 flex items-center justify-center mx-auto mb-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select a PDF file to convert to PDF/A format</CardDescription>
            </CardHeader>
              ...
              <div className="flex gap-4">
                ...
                {downloadUrl && (
                  <Button variant="outline" asChild>
                    <a href={downloadUrl} download={`${file?.name.replace(".pdf", "")}-pdfa.pdf`}>
