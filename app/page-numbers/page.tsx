...
import { Upload, FileText, Download, Loader2, Hash } from "lucide-react"
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto max-w-4xl px-6">
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-lg bg-purple-600 flex items-center justify-center mx-auto mb-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4">
                <Button onClick={handleAddPageNumbers} disabled={!file || isProcessing} className="flex-1">
                  {isProcessing ? (
                    <>
                ...
                {downloadUrl && (
                  <Button variant="outline" asChild>
                    <a href={downloadUrl} download={`${file?.name.replace(".pdf", "")}-numbered.pdf`}>
